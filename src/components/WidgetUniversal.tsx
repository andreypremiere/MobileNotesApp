...
export function WidgetUniversal({ chapter, setChapters, chapters,
    // handleUpdateChapter
}) {
    ...
    return (
        <TouchableOpacity
            style={chapter.section_id ? styles.itemsub : styles.item}
            onPress={
                chapter.section_id
                    ? () => navigation.navigate('SubtaskPage', { chapter })
                    : () => navigation.navigate('ChapterPage', { chapter })
            }
        >
